...
# --- 1. 全局配置 ---
MODEL_NAME = "autodl-tmp/Qwen2.5-7B-Instruct"  
OUTPUT_DIR = "autodl-tmp/hate-speech-qwen2.5-7B-lora"
...
def format_for_sft(example):
    """
    为SFTTrainer准备符合Instruct模型的文本格式。
    """
    system_prompt = (
...
if __name__ == "__main__":
    ...
    sft_ready_dataset = full_dataset.map(format_for_sft, remove_columns=list(full_dataset.features))
